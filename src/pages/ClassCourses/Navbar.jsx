...
export default function Navbar() {
  ...
  return (
    <>
      <header className={`fixed top-0 left-0 right-0 z-50 sm:z-50 bg-white shadow-sm px-4 sm:px-20 flex justify-between sm:items-center ${sideActive} transition duration-300 h-[60px] border-2`}>
